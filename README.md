...
Now, you'll want a local copy of this repo. You can make that with the commands:
    ...
    git clone https://github.com/oracle-devrel/terraform-oci-arch-cassandra.git
    cd terraform-oci-arch-cassandra
    ls
